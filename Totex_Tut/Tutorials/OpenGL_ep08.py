...
# Set Window Position for Pygame
os.environ['SDL_VIDEO_WINDOW_POS'] = '400,200'


# Creates a rotating textured 3D cube in pygame
...
# Create Vertex Texture Pointer using the layout location
...
# load image
texture_path = Path("Totex_Tut/Tutorials/textures/")
image_path = texture_path / "cat.png"
